...
const Contact = ({ darkMode }) => {
    ...
    return (
        <section id='contact'
            ...
            className='py-12 pt-24 sm:pt-16 sm:py-16 md:py-20 lg:py-24 overflow-hidden'>
                    ...
                    <form ref={form} onSubmit={sendEmail}
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4'>
                            <input type="text" name='first_name' placeholder='First Name'
                                ...
                                rounded-lg text-sm sm:text-base outline-none
                        ...
                        <input type="email" name='email' placeholder='Email Address'
                            ...
                            className='w-full px-3 sm:px-4 py-2 sm:py-3
                                rounded-lg text-sm sm:text-base mb-3 sm:mb-4 outline-none
                                focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all'
                            required />
                        {/* Phone Number*/}
                        ...
                        <textarea name='message'
                            ...
                            className='w-full px-3 sm:px-4 py-2 sm:py-3
                                rounded-lg text-sm sm:text-base mb-4 sm:mb-6 resize-none outline-none
                                focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all
                                placeholder-[#989696] dark:placeholder-gray-400'
                            required />
                        {/* Button */}
                        <button type='submit'
